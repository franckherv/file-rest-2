...
import 'package:nan_info/model_cor/model_cor.dart';
...
class HttpGlobalDatasource {
  ...
  Future<List<Category>> getUsers() async {
    try {
      ...
      */
      ...
      return (response.data["data"] as List).map((x) => Category.fromJson(x)).toList();
  ...
  // ===================== get single user data =====================//
    ...
    Future<Category> getSingleUser({String userId}) async {
    try {
